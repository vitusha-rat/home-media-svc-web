...
export const DownloadList: FC = () => {
  ...
  if (isLoading && !data) {
    return <LoadingOverlay message="Loading downloads..." />;
  }
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center py-12 sm:py-16 text-red-400 px-4">
        ...
        <p className="text-base sm:text-lg text-center">Failed to load downloads</p>
  ...
  if (downloads.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 sm:py-16 text-surface-500 px-4">
        ...
        <p className="text-base sm:text-lg text-center">No downloads yet</p>
        <p className="text-xs sm:text-sm mt-1 text-center">Search for torrents and start downloading</p>
      </div>
    );
  }
